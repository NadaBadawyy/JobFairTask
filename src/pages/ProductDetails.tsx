        ...
        <div className="mt-10">
          <div className="row md:flex-row flex-col justify-center items-center p-5   ">
            ...
            <div className="details md:w-1/2 w-full p-5  ">
              ...
              <p className="mt-10 mb-5 md:text-3xl text-2xl dark:text-white font-bold">{product.title}</p>
              ...
              <p className="text-xl font-semibold capitalize my-2 dark:text-white" >description:</p>
